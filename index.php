                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <li>
                                    ...
                                    <li>
                                        <a class="scroll-link" href="#divirta-se">
                                            Divirta-se
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class="col-md-5">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li>
                                        <a class="scroll-link" href="#contato">
                                            Contato
                                        </a>
                                    </li>
                                </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 app-features section-description wow fadeIn">
                <h2 class="letras-footer" style="color:#47B6BF;position: relative; left: -40%">
                    O Projeto
                </h2>
...
<div class="blog-container section-container-4">
    <div class="container letras-footer">
        <div class="row">
            <div class="col-sm-12 always-beautiful section-description wow fadeIn">
                <h2 class="letras-footer">
                    Blog
                ...
                <div class="col-md-4" style="position: relative;">
                    <img alt="" src="img/menino.jpg">
                </div>
                <div class="col-md-4" style="position: relative;">
                    <img alt="" src="img/balao.jpg">
                </div>
                <div class="col-md-4" style="position: relative">
                    <img alt="" src="img/menina.jpg">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <p style="text-align: justify; color: rgb(255, 161, 0); font-size: 13px; position:relative; left: 30%">
                Realização: Projet'Art | Design: Agência Zoom - Unasp-EC | Desenvolvimento: <a href="http://www.softlike.com.br" style="color: #fff;">Softlike</a>
            </p>
        </div>
    </div>
</div>
